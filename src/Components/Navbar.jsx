...
import { BsFillBellFill, BsFillCartFill, BsPersonCircle, BsFillCaretDownFill } from 'react-icons/bs';
    ...
    return (
        ...
        <>
            {location.pathname !== '/cadastro' && location.pathname !== '/login' && 
                ...
                <NavContainer onMouseEnter={() => setShowUserInfo(false)} onMouseLeave={() => setShowUserInfo(false)}>
                    ...
                    <div className="user-actions">
                        <Navbutton onMouseEnter={() => setShowUserInfo(true)} >
                            ...
                            {showUserInfo &&
                                <div onMouseLeave={() => setShowUserInfo(false)} className="user-info">
                        ...
                        <div className="cart">
                            ...
                            <p className="cart-items-amount">10</p>
                        </div>
                    </div>
                    </div>
                </NavContainer>
